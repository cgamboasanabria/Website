...
```{r info}
info <- list(cliente="Raquel Barrientos", empresa="UNICEF", 
             direccion="Pavas", teléfono="8888888", 
             correo="rbarrientos@unicef.org", validez=8, pago="50 adelantado y 50 contra entrega", condiciones_especiales="Puede haber alguna",
