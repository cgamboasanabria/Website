...
\subsection*{\Large{Cotizado el día 07 de febrero del 2020 a las 16:02:37.}}

\subsection*{\Large{Presupuesto para:}}

\text{\large{Sr(a)(ita): Raquel Barrientos }}

\text{\large{Empresa: UNICEF }}

\text{\large{Dirección:  Pavas }}

\text{\large{Teléfono: 8888888 | Correo electrónico: rbarrientos@unicef.org}}
...
\bottomrule
\endlastfoot
Puede haber alguna & 15 de febrero del 2020 a las 16:2:38 & 50 adelantado y 50 contra entrega & colones costarricences & 1\\*
\end{longtabu}
\endgroup{}
...
\bottomrule
\endlastfoot
1 & Cálculo de indicadores para la metodología de medición del IBINA & 1,392,888.0 & 0.0 & 1,392,888.0\\
 &  &  &  & \\
\hline
\textbf{Total} & \textbf{} & \textbf{} & \textbf{0.0} & \textbf{1,392,888.0}\\*
\end{longtabu}
\endgroup{}
