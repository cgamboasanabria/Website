...
```{r info}
info <- list(cliente="Ronald Brenes", empresa="Gente de Talento S.A.", 
             direccion="Guachipelín de Escazú, Edificio VMG, piso 1 San José, Costa Rica", teléfono="2506-3840", 
             correo="ronald.brenes@gentedt.com", validez=15, pago="50\\% para iniciar el análisis y 50\\% previo a la entrega del informe.", condiciones_especiales="El análisis realizado aplica exclusivamente para la muestra proporcionada.",
