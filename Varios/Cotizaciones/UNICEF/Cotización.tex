...
\subsection*{\Large{Cotizado el día 29 de junio del 2020 a las 13:38:22.}}

\subsection*{\Large{Presupuesto para:}}

\text{\large{Sr(a)(ita): Raquel Barrientos }}

\text{\large{Empresa: FONDO DE NACIONES UNIDAS PARA LA INFANCIA EN COSTA RICA }}

\text{\large{Dirección:  Oficentro la Virgen \#2, Pavas, San José, San José, Costa Rica }}

\text{\large{Teléfono: 2296-2034 | Correo electrónico: rabarrientos@unicef.org}}

\begingroup\fontsize{9}{11}\selectfont

\begin{longtabu} to \linewidth {>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{5cm}>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{6cm}>{\raggedright}X}
...
\bottomrule
\endlastfoot
 & 29 de julio del 2020 a las 13:38:23 & Al contado & dólares estadounidenses & 578.35\\*
\end{longtabu}
\endgroup{}
...
\bottomrule
\endlastfoot
Cálculo de indicadores para la metodología de medición del IBINA tomando como año base el 2019. & 2,000.0 & 0.0 & 2,000.0\\
Desagregación a nivel regional. & 228.6 & 0.0 & 228.6\\
Cálculo para el año 2018. & 61.7 & 0.0 & 61.7\\
Cálculo para el año 2017. & 64.5 & 0.0 & 64.5\\
Cálculo para el año 2016. & 67.4 & 0.0 & 67.4\\
Cálculo para el año 2015. & 70.4 & 0.0 & 70.4\\
 &  &  & \\
\hline
\textbf{} & \textbf{2,492.6} & \textbf{0.0} & \textbf{2,492.6}\\*
\end{longtabu}
\endgroup{}
