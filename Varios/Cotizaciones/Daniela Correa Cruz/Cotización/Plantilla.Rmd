...
```{r info}
info <- list(cliente="Daniela Correa Cruz", empresa="-", 
             direccion="-", teléfono="7270-0144", 
             correo="dcorreac@gmail.com", validez=15, pago="50\\% para iniciar el análisis y 50\\% previo a la entrega del informe.", condiciones_especiales="Las variables incluídas en la base de datos final están sujetas a la validez y disponibilidad de las mismas.",
